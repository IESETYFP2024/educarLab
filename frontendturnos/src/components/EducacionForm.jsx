...
const EducacionForm = () => {
    ...
    const fetchCueData = async () => {
        try {
            const response = await axios.get(`${IP}/api/cue`);
    ...
    const handleDateChange = async (date) => {
        ...
        try {
            const response = await axios.get(`${IP}/horarios/ocupados?fechaVisita=${formattedDate}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${IP}/post`, formData);
